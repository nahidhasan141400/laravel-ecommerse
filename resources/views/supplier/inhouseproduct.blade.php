                ...
                <div class="modal-content" style="width:178%">
                    ...
                    <div class="modal-body">
                        <div class="form-validation">
                            <form action="{{route('seller_product_save')}}" enctype="multipart/form-data"  method="post" id="step-form-horizontal" class="step-form-horizontal">
                                @csrf
                                <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="select_file">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="sellerfileupload" type="file" name="files" accept="image/x-png, image/gif, image/jpeg" >
                                                    </span>
                                                        <br>
                                                        <br>
                                    ...
                                    <section>
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <label class="col-form-label" for="flash_deal">Special product image
                                                </label>
                                                <div >
                                                    <input required type="file" class="form-control"  id="special_product"  name="special_product"/>   
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <label class="col-form-label" for="flash_deal">Featured product image
                                                </label>
                                                <div >
                                                    <input required type="file" class="form-control"  id="featured_product"  name="featured_product"/>   
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div >
                                                    <input  type="text" class="form-control"  id="video_link" name="video_link" placeholder="Enter your youtube video link..">   
                                                </div>
                                            </div>
                                        </div> 
                                    </section>
